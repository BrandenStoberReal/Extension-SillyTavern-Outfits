...
export interface ISillyTavernContext {
    ...
    addOneMessage(mes: SillyTavern.ChatMessage, options?: Partial<SillyTavern.AddMessageOptions & { type?: string, insertAfter?: number, insertBefore?: number }>): void;
    ...
    updateMessageBlock(messageId: number, message: SillyTavern.ChatMessage, options?: { rerenderMessage?: boolean }): void;
