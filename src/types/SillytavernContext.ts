...
// Properly declare the Popup class with both instance and static properties
declare global {
    var Popup: {
        new (
...
interface SlashCommandClosure {
    ...
    providedArgumentList: (SlashCommandNamedArgumentAssignment | SlashCommandUnnamedArgumentAssignment)[];
...
type UnnamedArguments = string | number | boolean | (string | number | boolean)[] | SlashCommandClosure | null;
...
interface ExecuteSlashCommandsOptions {
...
interface ExecuteSlashCommandsOnChatInputOptions {
    scope?: SlashCommandScope;
    parserFlags?: Record<string, boolean>;
...
type UniqueApis = string[];

interface SlashCommandExecutionError extends Error {
    line: number;
    column: number;
    hint: string;
    cause?: string;
...
export interface ISillyTavernContext {
    ...
    executeSlashCommandsWithOptions(text: string, options?: ExecuteSlashCommandsOptions): Promise<SlashCommandClosureResult>;
    registerSlashCommand(command: string, callback: (...args: any[]) => any, aliases: string[], helpString?: string): void;
    executeSlashCommands(text: string, handleParserErrors?: boolean, scope?: SlashCommandScope, handleExecutionErrors?: boolean, parserFlags?: Record<string, boolean>, abortController?: SlashCommandAbortController, onProgress?: (done: number, total: number) => void): Promise<SlashCommandClosureResult>;
