...
export const logInfo = (message: any, ...optionalParams: any[]): void => logger.info(message, ...optionalParams);
export const logWarn = (message: any, ...optionalParams: any[]): void => logger.warn(message, ...optionalParams);
export const logError = (message: any, ...optionalParams: any[]): void => logger.error(message, ...optionalParams);
